...
ensuredirectory(ftp, '/atmosphere/contents', "01006F8002326000")
ensuredirectory(ftp, f'/atmosphere/contents/01006F8002326000', 'exefs')

binaryPath = f'{os.path.basename(os.getcwd())}{version}.nso'
if os.path.isfile(binaryPath):
    sdPath = f'/atmosphere/contents/01006F8002326000/exefs/subsdk1'
    print(f'Sending {sdPath}')
    ftp.storbinary(f'STOR {sdPath}', open(binaryPath, 'rb'))

metaPath = f'park.npdm'
sdPath = '/atmosphere/contents/01006F8002326000/exefs/main.npdm'
print(f'Sending {sdPath}')
ftp.storbinary('STOR /atmosphere/contents/01006F8002326000/exefs/main.npdm', open(metaPath, 'rb'))