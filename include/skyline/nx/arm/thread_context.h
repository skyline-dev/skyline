 ...
 */
static inline bool threadContextIsAArch64(const ThreadContext* ctx) { return (ctx->psr & 0x10) == 0; }
 ...
 */
static inline bool threadExceptionIsAArch64(const ThreadExceptionDump* ctx) { return (ctx->pstate & 0x10) == 0; }
