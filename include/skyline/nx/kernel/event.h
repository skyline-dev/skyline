 ...
 */
static inline bool eventActive(Event* t) { return t->revent != INVALID_HANDLE; }
 ...
 * @param[in] t Pointer to \ref Event structure.
 * @return Result code.
 * @note This function only works for events initialized with \ref eventCreate, it doesn't work with events initialized
 * with \ref eventLoadRemote.
 * @warning This is a privileged operation; in normal circumstances applications shouldn't use this function.
 */
