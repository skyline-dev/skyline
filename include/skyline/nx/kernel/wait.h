...
/**
 * @brief Waits for an arbitrary number of kernel synchronization objects, optionally with a timeout. This function
 * replaces \ref svcWaitSynchronization.
 * @param[out] idx_out Variable that will received the index of the signalled object.
...
/**
 * @brief Helper macro for \ref waitObjects that accepts \ref Waiter structures as variadic arguments instead of as an
 * array.
